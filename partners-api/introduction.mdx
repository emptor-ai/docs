...
description: "Purchasing and inventory integration for partner systems — purchase requests, purchase orders, receipts, parts, and stock"
icon: "boxes-stacked"
---

The OpenWrench Partners API is the integration surface for partner systems that handle purchasing and inventory — typically the tooling behind internal service teams: purchase requests and their line items, purchase orders through receipt, parts and equipment catalogs, stock locations, and the parts consumed on work orders.
...
All partner endpoints are under `/v1/partners/`.

## Authentication

Send your API key in the `X-API-KEY` header on every request. The key automatically scopes every request to your company's data.
...
To get an API key, contact [support@useopenwrench.com](mailto:support@useopenwrench.com).
