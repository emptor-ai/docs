...
description: "Recevez, acceptez, refusez et faites progresser les bons de travail comme fournisseur : mises à jour de statut, suivi des pièces, dates d'achèvement estimées, pièces jointes, notes et étiquettes."
---
...
1. Recevez les nouveaux travaux via les [webhooks](/fr-CA/supplier-api/webhooks) (`workorder.create`), ou sondez la file (`sort_by=assignedAt`) et faites un delta sur `statusChangedAt`.
