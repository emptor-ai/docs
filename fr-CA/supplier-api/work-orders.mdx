...
Les endpoints de liste et de comptage servent aux deux moments qu'un webhook ne peut pas couvrir : le premier chargement du travail qui existait déjà avant l'enregistrement de votre endpoint, et une vérification périodique que rien n'a été manqué :
