...
description: "Accès programmatique pour les prestataires : bons de travail, appels de service, soumissions et factures, données WrenchMode et gestion de l'inventaire."
