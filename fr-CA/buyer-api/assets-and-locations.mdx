...
<Note>
Les charges utiles de compteur et de relevé sont analysées par un utilitaire côté serveur partagé, et le schéma documenté est abrégé. Les champs montrés ci-dessus constituent le noyau fiable; vérifiez tout ce qui va au-delà auprès des pages de référence de l'API ou du soutien.
</Note>
