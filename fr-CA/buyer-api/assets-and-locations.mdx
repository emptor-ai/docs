---
title: "Actifs, types d'actifs, modèles, compteurs et emplacements"
sidebarTitle: "Actifs et emplacements"
description: "Gérez emplacements et régions, types et modèles d'actifs, création d'actifs avec suivi des frigorigènes et relevés de compteurs dans l'API Acheteur."
---
...
- `fullChargeLb` accepte au plus 5 décimales et 14 chiffres au total, soit jusqu'à 9 chiffres avant le point décimal. Les décimales supplémentaires vous permettent de stocker exactement les conversions d'onces, par exemple `0.0625` (1 oz), `0.03125` (une demi-once) ou `0.00625` (un dixième d'once). OpenWrench refuse les valeurs plus précises avec une erreur `400`. Il ne les arrondit pas.
...
- `fullChargeLb` sur un actif suit les mêmes règles de positivité et de précision que sur un type d'actif.
