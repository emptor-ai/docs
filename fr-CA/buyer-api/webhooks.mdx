...
description: "Recevez sur votre endpoint les événements de création de bon de travail, changement de statut et nouvelle note, sans sonder l'API Acheteur OpenWrench."
---
