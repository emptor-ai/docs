---
title: "Bons de travail dans l'API Acheteur"
sidebarTitle: "Bons de travail"
description: "Créez, listez, filtrez, réaffectez et clôturez des bons de travail avec l'API Acheteur OpenWrench, incluant les actions de statut, les notes et les types de problèmes."
---
...
- **Drapeau d'approbation.** Le champ est `needApproval`, pas `needsApproval`. L'objet de réponse utilise `needsApproval`; la requête de création, non.
...
3. Suivez la progression du fournisseur via les [webhooks](/fr-CA/buyer-api/webhooks) (`workorder.status_update`), avec `GET /work_orders?statusChangedAt=...` comme sondage de repli.
