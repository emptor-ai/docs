...
- **Sous-actifs.** `subAssetIds` est un tableau optionnel d'ids de sous-actifs attachés en plus de l'`assetId` principal. Les sous-actifs sont des actifs créés avec un `parentId`; voir [Actifs](/buyer-api/assets-and-locations#actifs).
