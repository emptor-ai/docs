...
1. Ta emot nytt arbete via [webhooks](/supplier-api/webhooks) (`workorder.create`), eller polla kön (`sort_by=assignedAt`) och jämför på `statusChangedAt`.
