...
description: "Ta emot, acceptera, avvisa och driva arbetsordrar som leverantör: statusuppdateringar, reservdelsspårning, uppskattade slutdatum, bilagor, anteckningar och etiketter."
---
...
1. Ta emot nytt arbete via [webhooks](/sv/supplier-api/webhooks) (`workorder.create`), eller polla kön (`sort_by=assignedAt`) och jämför på `statusChangedAt`.
