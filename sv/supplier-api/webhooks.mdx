---
title: "Webhooks i Supplier API"
sidebarTitle: "Webhooks"
description: "Få besked i samma stund som en arbetsorder tilldelas dig, dess status ändras eller köparen lägger till en anteckning, i stället för att polla OpenWrench Supplier API."
---
