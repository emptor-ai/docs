...
description: "Få besked direkt när en arbetsorder tilldelas dig, statusen ändras eller köparen lägger till en anteckning, utan att polla OpenWrench Supplier API."
---
