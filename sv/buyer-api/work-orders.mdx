---
title: "Arbetsordrar i Buyer API"
sidebarTitle: "Arbetsordrar"
description: "Skapa, lista, filtrera, tilldela om och avsluta arbetsordrar med OpenWrench Buyer API, inklusive statusåtgärder, anteckningar och problemtyper."
---
...
3. Följ leverantörens framsteg via [webhooks](/sv/buyer-api/webhooks) (`workorder.status_update`), med `GET /work_orders?statusChangedAt=...` som polling-reserv.
