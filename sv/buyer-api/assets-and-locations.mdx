---
title: "Tillgångar, tillgångstyper, modeller, mätare och platser"
sidebarTitle: "Tillgångar och platser"
description: "Hantera Buyer API:s fysiska värld: platser och regioner, tillgångstyper och modeller, skapa tillgångar med köldmediespårning och registrera mätaravläsningar."
---
...
- `fullChargeLb` accepterar högst 5 decimaler och totalt 14 siffror, alltså upp till 9 siffror före decimaltecknet. De extra decimalerna gör att du kan lagra omräkningar från uns exakt, till exempel `0.0625` (1 oz), `0.03125` (ett halvt uns) eller `0.00625` (en tiondels uns). OpenWrench avvisar värden med högre precision med ett `400`-fel. Värdena avrundas inte.
...
- `fullChargeLb` på en tillgång följer samma regler för positivt värde och precision som på en tillgångstyp.
