---
title: "Webhooks i Buyer API"
sidebarTitle: "Webhooks"
description: "Få händelser för skapad arbetsorder, statusändring och ny anteckning skickade till din egen slutpunkt i stället för att polla OpenWrench Buyer API."
---
