...
The list and count endpoints are for the two moments a webhook cannot cover: the first load of work that already existed before your endpoint was registered, and a periodic check that nothing was missed:
