...
- **Freshness.** Search index and replica updates lag writes by a moment, so your own just-written change, or a work order assigned seconds ago, can be briefly absent from list results and counts.
