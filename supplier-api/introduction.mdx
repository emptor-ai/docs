...
Send your API key in the `X-API-KEY` header on every request. The key is issued per supplier contact and automatically scopes every request to your facility — you only ever see work orders, invoices, and data that belong to you.
