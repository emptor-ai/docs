...
<Note>
Los payloads de medidor y de lectura son parseados por un ayudante compartido del lado del servidor, y el esquema documentado está abreviado. Los campos mostrados arriba son el núcleo confiable; verifica cualquier cosa más allá contra las páginas de referencia de la API o con soporte.
</Note>
