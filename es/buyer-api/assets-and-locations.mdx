...
description: "Gestiona el mundo físico de la Buyer API: ubicaciones y regiones, tipos y modelos de activos, creación de activos con seguimiento de refrigerante y registro de lecturas de medidores."
---
