---
title: "Activos, tipos de activos, modelos, medidores y ubicaciones"
sidebarTitle: "Activos y ubicaciones"
description: "Gestiona ubicaciones y regiones, tipos y modelos de activos, creación de activos con seguimiento de refrigerante y lecturas de medidores en la Buyer API."
---
...
- `fullChargeLb` acepta como máximo 5 decimales y 14 dígitos en total, es decir, hasta 9 dígitos antes del punto decimal. Los decimales adicionales te permiten almacenar conversiones de onzas con exactitud, por ejemplo `0.0625` (1 oz), `0.03125` (media onza) o `0.00625` (una décima de onza). OpenWrench rechaza los valores con más precisión con un error `400`. No los redondea.
...
- `fullChargeLb` en un activo sigue las mismas reglas de positividad y precisión que en un tipo de activo.
