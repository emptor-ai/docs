...
description: "Crea, lista, filtra, reasigna y cierra órdenes de trabajo con la Buyer API de OpenWrench, incluidas acciones de estado, notas y tipos de problema."
---
...
3. Sigue el progreso del proveedor mediante [webhooks](/es/buyer-api/webhooks) (`workorder.status_update`), con `GET /work_orders?statusChangedAt=...` como sondeo de respaldo.
