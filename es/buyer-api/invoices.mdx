---
title: "Ciclo de vida de facturas y pagos en la Buyer API"
sidebarTitle: "Facturas"
description: "Lee, aprueba y paga facturas ancladas a órdenes de trabajo o proyectos con la Buyer API: estados, sincronización con AP y exportaciones aplanadas."
---
