...
description: "Acceso programático para proveedores: recibe órdenes de trabajo, programa llamadas de servicio, envía cotizaciones y facturas y gestiona el inventario."
