...
> Recibe, acepta, rechaza y avanza órdenes de trabajo como proveedor: actualizaciones de estado, seguimiento de partes, fechas estimadas de finalización, adjuntos, notas y etiquetas.
...
1. Recibe el trabajo nuevo mediante [webhooks](/supplier-api/webhooks) (`workorder.create`), o consulta la cola por sondeo (`sort_by=assignedAt`) y compara sobre `statusChangedAt`.
