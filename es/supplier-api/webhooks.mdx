---
title: "Webhooks en la Supplier API"
sidebarTitle: "Webhooks"
description: "Entérate en el momento en que se te asigna una orden de trabajo, cambia su estado o el comprador añade una nota, en lugar de sondear la Supplier API de OpenWrench."
---
