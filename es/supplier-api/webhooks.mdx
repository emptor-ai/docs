...
description: "Entérate al instante cuando se te asigna una orden de trabajo, cambia su estado o el comprador añade una nota, sin sondear la Supplier API de OpenWrench."
---
